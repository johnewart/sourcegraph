...
type GitMutation {
    ...
    createRefFromPatch(input: GitCreateRefFromPatchInput!): GitCreateRefFromPatchPayload
}

# Input arguments for GitMutation.createRefFromPatch.
input GitCreateRefFromPatchInput {
    # The repository in which to create the ref.
    repository: ID!

    # The full name of the ref (e.g., "refs/heads/mybranch" not just "mybranch").
    name: String!

    # The Git commit on top of which to apply the patch.
...
type GitCreateRefFromPatchPayload {
    # The newly created ref.
    ref: GitRef!
}

# A changeset is a set of changes to code, along with related discussion and automation.
#
...
# Mutations related to changesets.
type ChangesetsMutation {
    # Create a changeset.
    createChangeset(input: ChangesetsCreateChangesetInput!): ChangesetsCreateChangesetPayload
}
